...
export const SpeakerCard: React.FC<SpeakerProps> = ({
  ...
  title,
  organization,
  linkedInUrl = '#',  // Provide default value
  imageUrl
}) => {
      ...
      <div className="relative w-full h-full">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-900/40 to-black/60 backdrop-blur-sm rounded-xl overflow-hidden border border-white/10 shadow-xl">
          ...
          <div className="p-6 flex flex-col justify-between flex-1">
            <div>
              <h3 className="text-xl font-bold text-white mb-0">{name}</h3>
              <p className="text-amber-400 font-medium mb-1">{title}</p>
            ...
            {linkedInUrl && linkedInUrl !== '#' && (
              <a
                ...
                className="mt-4 flex items-center justify-center px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 rounded-lg text-blue-400 transition-colors cursor-pointer z-10"
              >
